  ...
  return (
    <>
        ...
        <div className="w-full md:w-[50%] mt-6 px-3">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="mb-3 text-sm sm:text-lg">
              <p className="flex text-secondary-color">
                Do you want to change your username?
                <input
                  type="submit"
                  className="text-accent-color hover:text-green-700 hover:underline
      ...
      <div className="max-w-6xl px-3 mt-6 mx-auto">
        <h2 className="text-2xl text-center font-semibold mb-6 pb-4 border-b-gray-300 border-b-2 text-secondary-color">
          My marked landmarks
        </h2>
